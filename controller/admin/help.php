...
class Help
{
    ...
    public function page()
    {
        ...
        <h3>Need Help?</h3>
        <ol>
            <li>View the <a href="https://www.fetchdesigns.com/sign-up-sheets-wordpress-plugin/#faq">Frequently Asked Questions</a></li>
            ...
            <li>Didn't find your answer with any of the above options? <a href="https://www.fetchdesigns.com/contact/">Email Fetch Designs</a></li>
        </ol>
